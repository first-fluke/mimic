...
5. **NEVER do**: Ignore analysis warnings with `// ignore:` comments
...
6. **After 3 failures**: Try different approach
...
Same: Refer to "Rate Limit" and "Serena Memory" sections in backend-agent playbook.
...
- **Scope exceeded**: For backend/frontend problems, only record in result
