...
**Symptoms**: User request is vague ("Make a good app", "Make it better")
...
5. **NEVER do**: Create tasks while ambiguous — agents will lose direction
...
- **Plan is not code**: Doesn't need to be perfect. Agents can adjust during execution
