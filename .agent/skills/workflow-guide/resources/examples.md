...
**Input**: "Create a TODO app with JWT authentication"
...
**Input**: "Add comment functionality to the blog"
...
**User**: "Run everything automatically" / "Run everything automatically"
