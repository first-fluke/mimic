...
exports.AntigravityBridge = void 0;
...
class AntigravityBridge {
    ...
    async getQuota(connection) {
        this.outputChannel.appendLine('[AntigravityBridge] Fetching Quota (Internal RPC)...');
        try {
            const data = await this.makeRequest(connection.port, '/exa.language_server_pb.LanguageServerService/GetUserStatus', connection.csrfToken, {
                metadata: {
                    ideName: 'antigravity',
     ...
     */
    async sendChatMessage(connection, prompt, modelId) {
        ...
        for (const port of portsToTry) {
            for (const endpoint of endpoints) {
                try {
                    ...
                    const response = await this.makeRequest(port, endpoint, connection.csrfToken, payload);
                    if (response) {
    ...
    makeRequest(port, path, csrfToken, body) {
...
exports.AntigravityBridge = AntigravityBridge;
//# sourceMappingURL=AntigravityBridge.js.map