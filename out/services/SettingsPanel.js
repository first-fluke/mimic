...
class SettingsPanel {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel('mimicSettings', 'MIMIC Settings', column || vscode.ViewColumn.One, {
    ...
    async _saveSettings(data) {
        try {
            ...
            if (data.anthropicApiKey !== undefined)
                await config.update('anthropicApiKey', data.anthropicApiKey, vscode.ConfigurationTarget.Global);
