...
export class InsightService {
    ...
    constructor(outputChannel: vscode.OutputChannel, workspaceRoot: string, eventsPath: string) {
     ...
     */
    private async callGoogleCloudAPI(token: string, prompt: string): Promise<string | null> {
