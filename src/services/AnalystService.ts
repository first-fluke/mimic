...
import { AntigravityOAuth } from './AntigravityOAuth';
...
export async function analyzePatterns(outputChannel: vscode.OutputChannel): Promise<void> {
...
async function handleAnalysisResult(markdown: string, outputChannel: vscode.OutputChannel): Promise<void> {
...
async function tryAntigravityBridge(prompt: string, outputChannel: vscode.OutputChannel): Promise<string | null> {
...
async function tryAntigravityCloud(prompt: string, outputChannel: vscode.OutputChannel): Promise<string | null> {
...
async function tryEditorNative(prompt: string, outputChannel: vscode.OutputChannel): Promise<string | null> {
...
async function tryGoogleToken(prompt: string, outputChannel: vscode.OutputChannel): Promise<string | null> {
...
async function tryCustomApiKey(prompt: string, outputChannel: vscode.OutputChannel): Promise<string | null> {
...
async function fallbackToClipboard(prompt: string, outputChannel: vscode.OutputChannel): Promise<void> {
